...
namespace _5032Assignment_1.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BookingId,ClientClientId,StaffStaffId")] Booking booking)
        {
            ...
            ViewBag.ClientClientId = new SelectList(db.Clients, "ClientId", "FirstName", booking.ClientClientId);
            ViewBag.StaffStaffId = new SelectList(db.Staffs, "StaffId", "StaffId", booking.StaffStaffId);
            return View(booking);
        }
